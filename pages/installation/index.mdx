...
```bash copy
docker exec -it mon-container-mongodb mongo    
```     

Vous êtes maintenant prêt à utiliser MongoDB dans un environnement isolé à l'université, en exploitant Docker comme plateforme de virtualisation légère. N'hésitez pas à me faire savoir si vous avez des questions supplémentaires ou si quelque chose n'est pas clair !